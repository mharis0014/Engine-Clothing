...
<title>SALE | Engine Clothing</title>
</head>
...
<body>
        ...
        <nav>
            <div class="row">
                ...
                <ul class="main-nav js--main-nav">
                    ...
                    <li><a style="color: #e67e22; font-weight: 400;" href="#">Sale</a></li>
    ...
    <section class="sec-cont" id="topwear">
        ...
        <div class="shop-items">
            ...
            <?php
            $get = mysqli_query($link, "SELECT * FROM  sale ");
            ...
            ?>
                ...
                <div class="shop-item">
                    ...
                    <div class="shop-item-details">
                        <span class="sale-item-price sale-price">$<?php echo htmlentities($row['product_price']);  ?></span>
                        <span class="sale-item-price">$<?php echo htmlentities($row['sale_price']);  ?></span>
                        <a class="btn btn-full btn-sale js--add-to-cart-btn atcb" href="#">ADD TO CART</a>
                    </div>
                </div>
