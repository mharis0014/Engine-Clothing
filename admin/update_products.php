...
<body>
    ...
    url(../resources/Images/engineKids.png);
  ...
  background-attachment: fixed;" id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <form action="updating_products.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="bbb">
                            <div class="dropdown">
                                ...
                                <select style="width:40%; margin-bottom:150px" class="form-control" id="select_1" name="category" required>
